...
public class CustomerDao implements CustomerService {
    ...
    private final String queryInsertCustomerWithId="Insert into  customer(customerId,firstName,lastName,dateOfBirth) values (?,?,?,?)";
    ...
    public void addCustomerWithId(Customer customer) throws CustomerException {
        try(PreparedStatement ps=connection.prepareStatement(queryInsertCustomerWithId)){
